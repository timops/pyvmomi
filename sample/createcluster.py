...
def GetArgs():
   ...
   parser.add_argument('-c', '--cluster', required=True, action='store', help='Name of cluster to create')
...
def main():
   ...
   try:
      ...
      hosts = datacenter.hostFolder
      cconfig = pyVmomi.vim.ClusterConfigSpecEx()
      hosts.CreateClusterEx(args.cluster, cconfig) 
      print "Creating cluster: ", args.cluster
