...
"""
Python program for creating a Datacenter on a vCenter host
"""
...
def GetArgs():
   ...
   parser.add_argument('-d', '--datacenter', required=True, action='store', help='Name of datacenter to create')
...
def main():
   ...
   try:
      ...
      task = root.CreateDatacenter(args.datacenter)
      print "Creating datacenter: ", args.datacenter
